...
#Documentation can be found here: http://www.kamailio.org/docs/modules/5.2.x/
IUSE_KAMAILIO_MODULES="kamailio_modules_acc kamailio_modules_acc_diameter kamailio_modules_acc_json kamailio_modules_acc_radius kamailio_modules_alias_db kamailio_modules_app_java kamailio_modules_app_jsdt kamailio_modules_app_lua kamailio_modules_app_mono kamailio_modules_app_perl kamailio_modules_app_python kamailio_modules_app_python3 kamailio_modules_app_ruby kamailio_modules_app_sqlang kamailio_modules_async kamailio_modules_auth kamailio_modules_auth_db kamailio_modules_auth_diameter kamailio_modules_auth_ephemeral kamailio_modules_auth_identity kamailio_modules_auth_radius kamailio_modules_auth_xkeys kamailio_modules_avp kamailio_modules_avpops kamailio_modules_benchmark kamailio_modules_blst kamailio_modules_call_control kamailio_modules_call_obj kamailio_modules_carrierroute kamailio_modules_cdp kamailio_modules_cdp_avp kamailio_modules_cfg_db kamailio_modules_cfg_rpc kamailio_modules_cfgutils kamailio_modules_cfgt kamailio_modules_cnxcc kamailio_modules_corex kamailio_modules_counters kamailio_modules_cplc kamailio_modules_crypto kamailio_modules_ctl kamailio_modules_db_berkeley kamailio_modules_db_cassandra kamailio_modules_db_cluster kamailio_modules_db_flatstore kamailio_modules_db_mongodb kamailio_modules_db_mysql kamailio_modules_db_oracle kamailio_modules_db_perlvdb kamailio_modules_db_postgres kamailio_modules_db_redis kamailio_modules_db_sqlite kamailio_modules_db_text kamailio_modules_db_unixodbc kamailio_modules_db2_ldap kamailio_modules_db2_ops kamailio_modules_debugger kamailio_modules_dialog kamailio_modules_dialplan kamailio_modules_dispatcher kamailio_modules_diversion kamailio_modules_dmq kamailio_modules_dmq_usrloc kamailio_modules_dnssec kamailio_modules_domain kamailio_modules_domainpolicy kamailio_modules_drouting kamailio_modules_enum kamailio_modules_erlang kamailio_modules_evapi kamailio_modules_evrexec kamailio_modules_exec kamailio_modules_geoip kamailio_modules_geoip2 kamailio_modules_group kamailio_modules_gzcompress kamailio_modules_h350 kamailio_modules_htable kamailio_modules_http_client kamailio_modules_http_async_client kamailio_modules_ims_auth kamailio_modules_ims_charging kamailio_modules_ims_dialog kamailio_modules_ims_diameter_server kamailio_modules_ims_icscf kamailio_modules_ims_ipsec_pcscf kamailio_modules_ims_isc kamailio_modules_ims_ocs kamailio_modules_ims_qos kamailio_modules_ims_registrar_pcscf kamailio_modules_ims_registrar_scscf kamailio_modules_ims_usrloc_pcscf kamailio_modules_ims_usrloc_scscf kamailio_modules_imc kamailio_modules_ipops kamailio_modules_jansson kamailio_modules_janssonrpcc kamailio_modules_json kamailio_modules_jsonrpcc kamailio_modules_jsonrpcs kamailio_modules_kazoo kamailio_modules_keepalive kamailio_modules_kex kamailio_modules_lcr kamailio_modules_ldap kamailio_modules_log_custom kamailio_modules_log_systemd kamailio_modules_malloc_test kamailio_modules_mangler kamailio_modules_matrix kamailio_modules_maxfwd kamailio_modules_mediaproxy kamailio_modules_memcached kamailio_modules_misc_radius kamailio_modules_mohqueue kamailio_modules_mqueue kamailio_modules_msilo kamailio_modules_msrp kamailio_modules_mtree kamailio_modules_nathelper kamailio_modules_nat_traversal kamailio_modules_ndb_cassandra kamailio_modules_ndb_mongodb kamailio_modules_ndb_redis kamailio_modules_nosip kamailio_modules_nsq kamailio_modules_osp kamailio_modules_outbound kamailio_modules_p_usrloc kamailio_modules_path kamailio_modules_pdb kamailio_modules_pdt kamailio_modules_peering kamailio_modules_permissions kamailio_modules_phonenum kamailio_modules_pike kamailio_modules_pipelimit kamailio_modules_prefix_route kamailio_modules_presence kamailio_modules_presence_conference kamailio_modules_presence_dialoginfo kamailio_modules_presence_mwi kamailio_modules_presence_profile kamailio_modules_presence_xml kamailio_modules_presence_reginfo kamailio_modules_print kamailio_modules_print_lib kamailio_modules_pua kamailio_modules_pua_bla kamailio_modules_pua_dialoginfo kamailio_modules_pua_json kamailio_modules_pua_reginfo kamailio_modules_pua_rpc kamailio_modules_pua_usrloc kamailio_modules_pua_xmpp kamailio_modules_purple kamailio_modules_pv kamailio_modules_qos kamailio_modules_rabbitmq kamailio_modules_ratelimit kamailio_modules_regex kamailio_modules_registrar kamailio_modules_rls kamailio_modules_rr kamailio_modules_rtimer kamailio_modules_rtjson kamailio_modules_rtpengine kamailio_modules_rtpproxy kamailio_modules_sanity kamailio_modules_sca kamailio_modules_sctp kamailio_modules_sdpops kamailio_modules_seas kamailio_modules_sipcapture kamailio_modules_sipdump kamailio_modules_sipt kamailio_modules_siptrace kamailio_modules_siputils kamailio_modules_sl kamailio_modules_sms kamailio_modules_smsops kamailio_modules_snmpstats kamailio_modules_speeddial kamailio_modules_sqlops kamailio_modules_ss7ops kamailio_modules_sst kamailio_modules_statistics kamailio_modules_statsc kamailio_modules_statsd kamailio_modules_stun kamailio_modules_tcpops kamailio_modules_textops kamailio_modules_textopsx kamailio_modules_timer kamailio_modules_tls kamailio_modules_tm kamailio_modules_tmrec kamailio_modules_tmx kamailio_modules_topoh kamailio_modules_topos kamailio_modules_topos_redis kamailio_modules_tsilo kamailio_modules_uac kamailio_modules_uac_redirect kamailio_modules_uid_auth_db kamailio_modules_uid_avp_db kamailio_modules_uid_domain kamailio_modules_uid_gflags kamailio_modules_uid_uri_db kamailio_modules_uri_db kamailio_modules_userblacklist kamailio_modules_usrloc kamailio_modules_utils kamailio_modules_uuid kamailio_modules_websocket kamailio_modules_xcap_client kamailio_modules_xcap_server kamailio_modules_xhttp kamailio_modules_xhttp_pi kamailio_modules_xhttp_rpc kamailio_modules_xlog kamailio_modules_xmlops kamailio_modules_xmlrpc kamailio_modules_xmpp kamailio_modules_xprint"
...
REQUIRED_USE="
	...
	kamailio_modules_cplc?          ( kamailio_modules_tm kamailio_modules_sl kamailio_modules_usrloc || ( kamailio_modules_db_berkeley kamailio_modules_db_cassandra kamailio_modules_db_cluster kamailio_modules_db_flatstore kamailio_modules_db_mongodb kamailio_modules_db_mysql kamailio_modules_db_oracle kamailio_modules_db_perlvdb kamailio_modules_db_postgres kamailio_modules_db_sqlite kamailio_modules_db_text kamailio_modules_db_unixodbc ) )
	...
	kamailio_modules_ims_qos?        ( kamailio_modules_dialog kamailio_modules_ims_usrloc_pcscf kamailio_modules_tm kamailio_modules_cdp kamailio_modules_cdp_avp )
	...
	kamailio_modules_janssonrpcc?   ( kamailio_modules_jansson kamailio_modules_tm )
	kamailio_modules_jsonrpcc?      ( kamailio_modules_tm )
	kamailio_modules_jsonrpcs?      ( kamailio_modules_xhttp )
	...
	kamailio_modules_snmpstats?      ( kamailio_modules_usrloc kamailio_modules_dialog )
	...
	kamailio_modules_sst?            ( kamailio_modules_sl kamailio_modules_dialog )
...
DEPEND="app-text/docbook2X
	...
	kamailio_modules_cnxcc?				( dev-libs/hiredis dev-libs/libevent )
	kamailio_modules_cplc?				( dev-libs/libxml2 )
	...
	kamailio_modules_http_async_client?	( net-misc/curl dev-libs/libev )
	...
	kamailio_modules_rabbitmq? ( net-libs/rabbitmq-c )
	...
	kamailio_modules_websocket?	( dev-libs/openssl dev-libs/libunistring )
	kamailio_modules_xcap_client?	( net-misc/curl dev-libs/libxml2 )
...
src_configure() {
	...
	einfo "Included modules: ${KAMODULES}"
